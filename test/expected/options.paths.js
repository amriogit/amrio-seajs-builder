define("fixtures/biz/login/index", [ "$", "angular", "bootstrap" ], function(require, exports, module) {
    "use strict";
    var $ = require("$");
...
define("fixtures/biz/login/error-msg", [], function(require, exports, module) {
    "use strict";
    require("amrio/tools/index");
    module.exports = {
        error: "error"
...
define("fixtures/biz/login/style.css", [], function() {
